	...
	public void run(String... args) {
		...
		ProjSeed[] projSeeds = {
				new ProjSeed("Système de Gestion des Soutenances",
						"Développement d'une plateforme web pour la gestion des soutenances de PFE.", "PFE", "pending",
						teacherT3),
				new ProjSeed("Application E-commerce Mobile",
						"Application mobile de vente en ligne avec recommandations personnalisées.", "PFE", "approved",
						teacherT4),
				new ProjSeed("Plateforme IoT pour Smart Campus",
						"Plateforme IoT connectant les capteurs du campus universitaire.", "PFE", "pending", teacherT5),
				new ProjSeed("Analyse Prédictive des Données Climatiques",
						"Analyse et prédiction des données climatiques avec deep learning.", "MEMOIRE", "approved",
						teacherT6),
				new ProjSeed("Chatbot Intelligent pour Services Universitaires",
						"Chatbot intelligent basé sur NLP pour les services universitaires.", "THESE", "approved",
						teacherT7),
				new ProjSeed("Système de Recommandation de Cours",
						"Système de recommandation de cours basé sur les compétences.", "PFE", "pending", teacherT8),
				new ProjSeed("Application Blockchain pour Diplômes",
						"Application blockchain pour la vérification des diplômes.", "PFE", "approved", teacherT9),
				new ProjSeed("Outil de Visualisation de Données Génomiques",
						"Outil de visualisation interactive de données génomiques.", "MEMOIRE", "approved", teacherT10),
				new ProjSeed("Assistant Virtuel pour Bibliothèque",
						"Assistant virtuel pour la gestion de bibliothèque universitaire.", "PFE", "pending",
						teacherT11),
				new ProjSeed("Système de Détection de Fraude Academique",
						"Système de détection de fraude académique par machine learning.", "THESE", "approved",
						teacherT12),
				new ProjSeed("Robot Autonome de Livraison",
						"Conception d'un robot autonome pour la livraison intra-campus.", "PFE", "pending", teacherT13),
				new ProjSeed("Application de Réalité Augmentée pour l'Anatomie",
						"Application mobile de réalité augmentée pour l'étude de l'anatomie.", "PFE", "approved",
						teacherT14),
				new ProjSeed("Plateforme de E-Learning Adaptatif",
						"Plateforme d'apprentissage adaptatif utilisant l'IA.", "MEMOIRE", "approved", teacherT3),
				new ProjSeed("Système de Reconnaissance Faciale",
						"Système de reconnaissance faciale pour la sécurité du campus.", "PFE", "pending", teacherT4),
				new ProjSeed("Optimisation des Transports Urbains",
						"Optimisation des transports urbains avec algorithmes génétiques.", "THESE", "approved",
						teacherT5),
				new ProjSeed("Jeu Sérieux pour l'Apprentissage de la Programmation",
						"Jeu sérieux pour l'apprentissage de la programmation orientée objet.", "PFE", "pending",
						teacherT6),
				new ProjSeed("Application de Télémédecine", "Application de télémédecine avec consultation en ligne.",
						"MEMOIRE", "approved", teacherT7),
				new ProjSeed("Système de Gestion d'Énergie Solaire",
						"Système de gestion intelligente de l'énergie solaire.", "PFE", "approved", teacherT8),
				new ProjSeed("Outil d'Analyse de Sentiments Twitter",
						"Outil d'analyse des sentiments sur Twitter en temps réel.", "THESE", "pending", teacherT9),
				new ProjSeed("Plateforme de Crowdfunding pour Projets Étudiants",
						"Plateforme de crowdfunding dédiée aux projets étudiants.", "PFE", "approved", teacherT10),
				new ProjSeed("Système de Détection d'Intrusions Réseau",
						"Système de détection d'intrusions basé sur l'apprentissage automatique.", "PFE", "pending",
						teacherT11),
				new ProjSeed("Application de Suivi de Présence NFC",
						"Application de suivi de présence utilisant la technologie NFC.", "MEMOIRE", "approved",
						teacherT12),
				new ProjSeed("Générateur Automatique de Comptes Rendus",
						"Générateur automatique de comptes rendus de réunions.", "PFE", "pending", teacherT13),
				new ProjSeed("Plateforme de Mentorat Étudiant",
						"Plateforme de mentorat connectant étudiants et professionnels.", "THESE", "approved",
						teacherT14),
				new ProjSeed("Système de Notation Automatique de Copies",
						"Système de notation automatique de copies avec deep learning.", "PFE", "approved",
						teacherT3),};
		...
		record EvalSeed(Long tid, Long dsid, Long pid, String role, Double score, String status,
		...
		List<EvalSeed> evalSeeds = Arrays.asList(
				new EvalSeed(teachers.get(0).getId(), ds1.getId(), projects.get(0).getId(), "Président", 16.4,
						"submitted", LocalDateTime.of(2026, 6, 20, 10, 0)),
		...
		NotifSeed[] notifSeeds = {
				new NotifSeed("info", "Nouvelle soutenance programmée",
						"Message détaillé pour nouvelle soutenance programmée.", 10, 5, true, "admin@univh2c.ma"),
				new NotifSeed("warning", "Soumission de document", "Message détaillé pour soumission de document.", 11,
						5, true, "coord@univh2c.ma"),
				new NotifSeed("success", "Rappel: date limite approche",
						"Message détaillé pour rappel: date limite approche.", 12, 5, true, "admin@univh2c.ma"),
				new NotifSeed("error", "Changement de jury", "Message détaillé pour changement de jury.", 13, 5, true,
						"coord@univh2c.ma"),
				new NotifSeed("reminder", "Note publiée", "Message détaillé pour note publiée.", 14, 5, true,
						"admin@univh2c.ma"),
				new NotifSeed("info", "Soutenance annulée", "Message détaillé pour soutenance annulée.", 15, 5, true,
						"coord@univh2c.ma"),
				new NotifSeed("warning", "Nouveau projet ajouté", "Message détaillé pour nouveau projet ajouté.", 16, 5,
						true, "admin@univh2c.ma"),
				new NotifSeed("success", "Date de soutenance modifiée",
						"Message détaillé pour date de soutenance modifiée.", 17, 5, true, "coord@univh2c.ma"),
				new NotifSeed("error", "Feedback disponible", "Message détaillé pour feedback disponible.", 18, 5, true,
						"admin@univh2c.ma"),
				new NotifSeed("reminder", "Inscription confirmée", "Message détaillé pour inscription confirmée.", 19,
						5, true, "coord@univh2c.ma"),
				new NotifSeed("info", "Session ouverte", "Message détaillé pour session ouverte.", 20, 5, true,
						"admin@univh2c.ma"),
				new NotifSeed("warning", "Compte rendu disponible", "Message détaillé pour compte rendu disponible.",
						21, 5, true, "coord@univh2c.ma"),
				new NotifSeed("success", "Nouvelle soutenance programmée",
						"Message détaillé pour nouvelle soutenance programmée.", 22, 5, true, "admin@univh2c.ma"),
				new NotifSeed("error", "Soumission de document", "Message détaillé pour soumission de document.", 23, 5,
						true, "coord@univh2c.ma"),
				new NotifSeed("reminder", "Rappel: date limite approche",
						"Message détaillé pour rappel: date limite approche.", 24, 5, true, "admin@univh2c.ma"),
				new NotifSeed("info", "Changement de jury", "Message détaillé pour changement de jury.", 25, 5, false,
						"coord@univh2c.ma"),
				new NotifSeed("warning", "Note publiée", "Message détaillé pour note publiée.", 26, 5, false,
						"admin@univh2c.ma"),
				new NotifSeed("success", "Soutenance annulée", "Message détaillé pour soutenance annulée.", 27, 5,
						false, "coord@univh2c.ma"),
				new NotifSeed("error", "Nouveau projet ajouté", "Message détaillé pour nouveau projet ajouté.", 28, 5,
						false, "admin@univh2c.ma"),
				new NotifSeed("reminder", "Date de soutenance modifiée",
						"Message détaillé pour date de soutenance modifiée.", 29, 5, false, "coord@univh2c.ma"),
				new NotifSeed("info", "Feedback disponible", "Message détaillé pour feedback disponible.", 10, 5, false,
						"admin@univh2c.ma"),
				new NotifSeed("warning", "Inscription confirmée", "Message détaillé pour inscription confirmée.", 11, 5,
						false, "coord@univh2c.ma"),
				new NotifSeed("success", "Session ouverte", "Message détaillé pour session ouverte.", 12, 5, false,
						"admin@univh2c.ma"),
				new NotifSeed("error", "Compte rendu disponible", "Message détaillé pour compte rendu disponible.", 13,
						5, false, "coord@univh2c.ma"),
				new NotifSeed("reminder", "Nouvelle soutenance programmée",
						"Message détaillé pour nouvelle soutenance programmée.", 14, 5, false, "admin@univh2c.ma"),
				new NotifSeed("info", "Soumission de document", "Message détaillé pour soumission de document.", 15, 5,
						false, "coord@univh2c.ma"),
				new NotifSeed("warning", "Rappel: date limite approche",
						"Message détaillé pour rappel: date limite approche.", 16, 5, false, "admin@univh2c.ma"),
				new NotifSeed("success", "Changement de jury", "Message détaillé pour changement de jury.", 17, 5,
						false, "coord@univh2c.ma"),
				new NotifSeed("error", "Note publiée", "Message détaillé pour note publiée.", 18, 5, false,
						"admin@univh2c.ma"),
				new NotifSeed("reminder", "Soutenance annulée", "Message détaillé pour soutenance annulée.", 19, 5,
						false, "coord@univh2c.ma"),};
